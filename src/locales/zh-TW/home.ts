...
export const HOME = {
  ...
  [HOME_KEYS.EMPTY_NICKNAME]: `@:${HOME_KEYS.PLEASE_INPUT}@:${HOME_KEYS.NICKNAME}作為您的房間暱稱`,
  [HOME_KEYS.EMPTY_PASSWORD]: `@:${HOME_KEYS.PLEASE_INPUT}@:${HOME_KEYS.PASSWORD}進入房間`,
  [HOME_KEYS.EMPTY_ROOM_NUMBER]: `@:${HOME_KEYS.PLEASE_INPUT}@:${HOME_KEYS.ROOM_NUMBER}進入房間`,
};
