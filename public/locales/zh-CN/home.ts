...
export const HOME = {
  ...
  [HOME_KEYS.EMPTY_NICKNAME]: `@:${HOME_KEYS.PLEASE_INPUT} @:${HOME_KEYS.NICKNAME} 作为您的房间昵称`,
  [HOME_KEYS.EMPTY_PASSWORD]: `@:${HOME_KEYS.PLEASE_INPUT} @:${HOME_KEYS.PASSWORD} 进入房间`,
  [HOME_KEYS.EMPTY_ROOM_NUMBER]: `@:${HOME_KEYS.PLEASE_INPUT} @:${HOME_KEYS.ROOM_NUMBER} 进入房间`,
};
